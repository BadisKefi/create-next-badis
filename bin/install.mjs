...
if (process.argv.length < 3) {
  ...
  console.log("    npx create-next-badis my-app");
  process.exit(1);
}
...
const git_repo = "https://github.com/BadisKefi/create-next-badis.git";
...
try {
  ...
  // Add .env file creation here
  fs.writeFileSync(".env", "# env variables go here\n");
